...
$savewallet=new Pesawallet;
$savewallet->refid=$reference;
$savewallet->amount=$amount;
$savewallet->user_id=Auth::user()->id;
$savewallet->save();


$callback_url = 'http://127.0.0.1:8000/checkout-load-successful'; //redirect url, the page that will handle the response from pesapal.

$post_xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?><PesapalDirectOrderInfo xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" Amount=\"".$amount."\"  Description=\"".$desc."\" Type=\"".$type."\" Currency=\"".$unit."\" Reference=\"".$reference."\" FirstName=\"".$first_name."\" LastName=\"".$last_name."\" Email=\"".$email."\" PhoneNumber=\"".$phonenumber."\" xmlns=\"http://www.pesapal.com\" />";
