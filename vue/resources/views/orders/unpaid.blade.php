	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12">
				<h6 class=""><a href="{{ url('/order',$order->id) }}"># {{$order->id}}</a></h6>
					...
					<div class="">
						<span class="text-gray font-weight-semibold">
									<span class=""> <span class="badge badge-pill badge-info">Pending Payment</span></span>
									</span>
						<span class="m-h-5 text-gray">|</span>
						
						<span class="badge badge-pill badge-default timer">Due Date <strong>{{$newDate}}</strong></span>
						<span class="badge badge-pill badge-default timer">Timer <strong> @if(strtotime($str)>$t)
				...
				<strong >Subject: </strong><span class="badge-pill badge-default badge-cyan">{{$subjects->subject}}</span>  <strong >Type of Paper: </strong> <span class="badge badge-pill badge-default">{{$types->type}}</span> <strong >Pages: </strong> <span class="badge badge-pill badge-default">{{$order->pages}}</span>
