...
$revisions=App\Order::where('status',4)->where('is_deleted',0)->get();
...
$arecent=App\Order::orderBy('created_at','DESC')->take(5)->get();  
...
<div class="row">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            ...
                            <img alt="" class="img-thumbnail rounded-circle" src="{{ URL::asset('assets/images/avatars/'.Auth::user()->avatar)}}" alt="">
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                           <div class="row"> 
                                ...
                                <div class="col-5">
                                    <h5 class="font-size-15"> $<b>{{$tutor->balance}}</b></h5>
    ...
    <div class="col-xl-8">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium">Available</p>
            ...
            <div class="col-md-4">
                ...
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium">Completed</p>
                                <h4 class="mb-0">{{ count($completed) }}</h4>
                            </div>
            ...
            <div class="col-md-4">
                <a href="{{ url('my-revisions') }}">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium">Revision</p>
                                <h4 class="mb-0">{{ count($revisions) }}</h4>
                            </div>
