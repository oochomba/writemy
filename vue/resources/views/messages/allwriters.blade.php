...
<div class="row">
	<div class="col-md-6">
			@php
                $clients=App\User::where('role',4)->count();
            @endphp					
									
		<div class="card">
		<div class="card-header">
			<h4 class="card-title">Send Message To All Writers: <b>{{ $clients }}</b></h4>
		</div>
		<div class="card-body">
		
			<form  enctype="multipart/form-data" method="post" action="{{ url('/post-all-writers') }}">
			{{ csrf_field() }}
